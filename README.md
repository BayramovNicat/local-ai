...
└── workers/
    ...
    └── rag-worker.ts                 # Embedding model and search Web Worker
```

### How RAG Works

1. **Document upload** — Files are extracted, chunked (512 chars, 64 overlap), embedded via `snowflake-arctic-embed-m`, and stored in IndexedDB
